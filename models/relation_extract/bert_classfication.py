...
class BertRE(nn.Module):
    ...
    def __init__(self, emb_size, num_classes, pretrained_model_path, dropout=0.1):
        ...
        self.fc = nn.Linear(self.embedding_dim * 3, self.num_classes)
    ...
    def forward(self, token_ids, token_type_ids, attention_mask, e1_mask, e2_mask):
        ...
        out = self.fc(self.drop(concat_h))
